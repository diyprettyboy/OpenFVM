...
Extrude Surface { 30, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 32, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 34, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 36, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 38, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 40, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 42, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 44, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 46, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 48, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 49, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 53, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 56, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 60, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 65, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 69, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 74, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 79, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 84, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

Extrude Surface { 87, {0,0,depth} } {
  Layers { {nz}, {9000}, {1.0} };
  Recombine;
};

// Empty
Physical Surface(600) = {111,133,155,199,221,287,309,331,353,375,397,419,441,463,485,485,507,529,265,243,177,146,74,79,69,87,84,49,32,30,48,46,40,38,36,42,44,34,53,111,56,150,60,65};
...
// Walls
Physical Surface(603) = {98,186,216,296,516,494,480,450};

// Cylinder
Physical Surface(604) = {252,406,234,172,146,344,370,388};

Physical Volume(610) = {9000};
