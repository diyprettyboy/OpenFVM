...
Point(5) = {dx*0.5,dy*0.5,0.0,lc};

Point(6) = {dx*0.4,dy*0.4,0.0,lc};
Point(7) = {dx*0.4,dy*0.6,0.0,lc};
Point(8) = {dx*0.6,dy*0.6,0.0,lc};
Point(9) = {dx*0.6,dy*0.4,0.0,lc};

Point(10) = {0.0,dy*0.4,0.0,lc};
Point(11) = {dx,dy*0.4,0.0,lc};

Point(12) = {0.0,dy*0.6,0.0,lc};
Point(13) = {dx,dy*0.6,0.0,lc};

Point(14) = {dx*0.4,0,0.0,lc};
Point(15) = {dx*0.4,dy,0.0,lc};

Point(16) = {dx*0.6,0,0.0,lc};
Point(17) = {dx*0.6,dy,0.0,lc};
