...
#define nphi     6		// Number of main variables
...
#define ipp      0		// Pressure (previous iteration)
#define ism      1		// Indicator function (smoothed)

#define naux     2		// Number of auxiliary
