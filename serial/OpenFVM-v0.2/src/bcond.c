...
void GetEntrySurface(FILE *fp, int j)
{
	...
	fscanf(fp, "%s", &gs);						
	bcsurfaces[nbbcsurfaces + j].fu = calloc(strlen(gs), sizeof(char));
	strcpy(bcsurfaces[nbbcsurfaces + j].fu, gs);
						
	fscanf(fp, "%s", &gs);						
	bcsurfaces[nbbcsurfaces + j].fv = calloc(strlen(gs), sizeof(char));
	strcpy(bcsurfaces[nbbcsurfaces + j].fv, gs);
							
	fscanf(fp, "%s", &gs);						
	bcsurfaces[nbbcsurfaces + j].fw = calloc(strlen(gs), sizeof(char));
	strcpy(bcsurfaces[nbbcsurfaces + j].fw, gs);

	fscanf(fp, "%s", &gs);						
	bcsurfaces[nbbcsurfaces + j].fp = calloc(strlen(gs), sizeof(char));
	strcpy(bcsurfaces[nbbcsurfaces + j].fp, gs);
						
	fscanf(fp, "%s", &gs);						
	bcsurfaces[nbbcsurfaces + j].fT = calloc(strlen(gs), sizeof(char));
	strcpy(bcsurfaces[nbbcsurfaces + j].fT, gs);
				
	fscanf(fp, "%s", &gs);						
	bcsurfaces[nbbcsurfaces + j].fs = calloc(strlen(gs), sizeof(char));
	strcpy(bcsurfaces[nbbcsurfaces + j].fs, gs);

	printf("\n");
	printf("Surface: %d, fu: %s\n", bcsurfaces[nbbcsurfaces + j].physreg, bcsurfaces[nbbcsurfaces + j].fu);
	printf("Surface: %d, fv: %s\n", bcsurfaces[nbbcsurfaces + j].physreg, bcsurfaces[nbbcsurfaces + j].fv);
	printf("Surface: %d, fw: %s\n", bcsurfaces[nbbcsurfaces + j].physreg, bcsurfaces[nbbcsurfaces + j].fw);
	printf("Surface: %d, fp: %s\n", bcsurfaces[nbbcsurfaces + j].physreg, bcsurfaces[nbbcsurfaces + j].fp);
	printf("Surface: %d, fT: %s\n", bcsurfaces[nbbcsurfaces + j].physreg, bcsurfaces[nbbcsurfaces + j].fT);
	printf("Surface: %d, fs: %s\n", bcsurfaces[nbbcsurfaces + j].physreg, bcsurfaces[nbbcsurfaces + j].fs);
	
}

void GetEntryVolume(FILE *fp, int j)
{
	...
	fscanf(fp, "%s", &gs);						
	bcvolumes[nbbcvolumes + j].fu = calloc(strlen(gs), sizeof(char));
	strcpy(bcvolumes[nbbcvolumes + j].fu, gs);
						
	fscanf(fp, "%s", &gs);						
	bcvolumes[nbbcvolumes + j].fv = calloc(strlen(gs), sizeof(char));
	strcpy(bcvolumes[nbbcvolumes + j].fv, gs);
							
	fscanf(fp, "%s", &gs);						
	bcvolumes[nbbcvolumes + j].fw = calloc(strlen(gs), sizeof(char));
	strcpy(bcvolumes[nbbcvolumes + j].fw, gs);

	fscanf(fp, "%s", &gs);						
	bcvolumes[nbbcvolumes + j].fp = calloc(strlen(gs), sizeof(char));
	strcpy(bcvolumes[nbbcvolumes + j].fp, gs);
						
	fscanf(fp, "%s", &gs);						
	bcvolumes[nbbcvolumes + j].fT = calloc(strlen(gs), sizeof(char));
	strcpy(bcvolumes[nbbcvolumes + j].fT, gs);
					
	fscanf(fp, "%s", &gs);						
	bcvolumes[nbbcvolumes + j].fs = calloc(strlen(gs), sizeof(char));
	strcpy(bcvolumes[nbbcvolumes + j].fs, gs);	

	printf("\n");
	printf("Volume: %d, fu: %s\n", bcvolumes[nbbcvolumes + j].physreg, bcvolumes[nbbcvolumes + j].fu);
	printf("Volume: %d, fv: %s\n", bcvolumes[nbbcvolumes + j].physreg, bcvolumes[nbbcvolumes + j].fv);
	printf("Volume: %d, fw: %s\n", bcvolumes[nbbcvolumes + j].physreg, bcvolumes[nbbcvolumes + j].fw);
	printf("Volume: %d, fp: %s\n", bcvolumes[nbbcvolumes + j].physreg, bcvolumes[nbbcvolumes + j].fp);
	printf("Volume: %d, fT: %s\n", bcvolumes[nbbcvolumes + j].physreg, bcvolumes[nbbcvolumes + j].fT);
	printf("Volume: %d, fs: %s\n", bcvolumes[nbbcvolumes + j].physreg, bcvolumes[nbbcvolumes + j].fs);
		...
		if (strcmp(descr, "$BOUND") == 0)
		{
			...
			for (i = 0; i < nbbcd; i++)
			{
				...
				case 10000:
					...
					bcsurfaces = realloc(bcsurfaces, (nbbcsurfaces + n) * sizeof(bcd_surface));
				...
				case 10250:
					...
					bcvolumes = realloc(bcvolumes, (nbbcvolumes + n) * sizeof(bcd_volume));
