...
msh_vector GeoNormalizeVector(msh_vector v1)
{
...
double GeoDotProduct(msh_vector v1, msh_vector v2)
{
...
double GeoCalcTriArea(msh_vector n1, msh_vector n2, msh_vector n3)
{
	...
	area = (0.5 * fabs(normal.x * sum.x + normal.y * sum.y + normal.z * sum.z));
...
double GeoCalcTetraVolume(msh_vector n1, msh_vector n2, msh_vector n3, msh_vector n4)
{
	...
	volume = fabs((n2.x-n1.x)*((n3.y-n1.y)*(n4.z-n1.z)-(n4.y-n1.y)*(n3.z-n1.z))-
...
void GeoCalcRotation(msh_vector *v, msh_vector axis, msh_vector v0, double angle)
{
