...
Point(6) = {dimx, dimy*0.5, 0, 0.1};
Point(7) = {dimx*0.5, dimy, 0, 0.1};
Point(8) = {0, dimy*0.5, 0, 0.1};

Point(9) = {dimx*0.5, dimy*0.5, 0, 0.1};
...
Transfinite Line {9,7,5} = n+1 Using Progression 1.0;
Transfinite Line {4,2,11} = n+1 Using Progression 1.0;
